    ...
    <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="nav nav-tabs upper">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo base_url();?>admin/upload_marks/"><i class="os-icon picons-thin-icon-thin-0007_book_reading_read_bookmark"></i><span><?php echo get_phrase('upload_marks');?></span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>admin/tab_sheet/"><i class="os-icon picons-thin-icon-thin-0197_layout_grid_view"></i><span><?php echo get_phrase('tabulation_sheet');?></span></a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="content-box">
          ...
          <?php echo form_open(base_url() . 'admin/marks_selector', array('class' => 'form m-b'));?>
            ...
            <div class="element-box lined-primary shadow">
              ...
              <br>
              <?php echo form_open(base_url() . 'admin/marks_update/'.$exam_id.'/'.$class_id.'/'.$subject_id);?>
